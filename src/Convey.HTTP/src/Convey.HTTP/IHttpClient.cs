...
namespace Convey.HTTP
{
    public interface IHttpClient
    {
        ...
        Task<T> PostAsync<T>(string uri, HttpContent content = null);
        Task<HttpResult<T>> PostResultAsync<T>(string uri, object data = null);
        Task<HttpResult<T>> PostResultAsync<T>(string uri, HttpContent content = null);
        ...
        Task<T> PutAsync<T>(string uri, HttpContent content = null);
        Task<HttpResult<T>> PutResultAsync<T>(string uri, object data = null);
        Task<HttpResult<T>> PutResultAsync<T>(string uri, HttpContent content = null);
        ...
        Task<T> PatchAsync<T>(string uri, HttpContent content = null);
        Task<HttpResult<T>> PatchResultAsync<T>(string uri, object data = null);
        Task<HttpResult<T>> PatchResultAsync<T>(string uri, HttpContent content = null);
